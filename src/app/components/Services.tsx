...
const Services = (props: Props) => {
  return (
    <div className='w-10/12 mx-auto relative top-40'>
        ...
        <div className='flex max-md:flex-wrap gap-7 justify-between'>
            <div className='d p-5 relative overflow-hidden mt-5'>
                ...
                <div className='flex justify-center mt-4'>
                    <MdDesignServices className='text-pink-500' size={28} />
                </div>
                <p className='text-center mt-10 text-neutral-300'>
                    <span className='text-xl font-bold'>ui/ux </span>
                    designer creating compelling user interface
                </p>
                <p className='text-center mt-10 mb-7'><a href="" className='px-4 py-2 rounded-sm border-[0.5px] border-[#363636] shadow-md text-gray-400 hover:text-green-500'>Load More!</a></p>
                <span className='w-[60px] h-[60px] z-[-2] blur-[100px] left-[45%] bg-white absolute top-0'></span>
                <span className='w-[20px] h-[20px] z-[-1] blur-[20px] left-[48%] bg-pink-600 absolute top-[27%]'></span>
            ...
            <div className='d p-5 relative overflow-hidden mt-5'>
                <h1 className='text-center mt-5'>Clean and Organize Code</h1>
                <div className='flex justify-center mt-4'>
                    <MdDeveloperMode className='text-pink-500' size={28} />
                </div>
                <p className='text-center mt-10 text-neutral-300'>
                    <span className='text-xl font-bold'>ui/ux </span>
                    designer creating compelling user interface
