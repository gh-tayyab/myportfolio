    ...
    <section className='grid  md:grid-cols-2 my-12 md:my-12 py-24 gap-4'>
        ...
        <div className='relative left-[20px]'>
            ...
            <div className='socials flex flex-row gap-2'>
                <Link  href='https://github.com/gh-tayyab'>
                    <FaGithub  className='text-white text-[50px]' />
                </Link>
                <Link href='https://www.linkedin.com/in/muhammad-tayyab-6661102a1/'>
        ...
        <div>
            <form className='flex flex-col'>
                ...
                block w-full p-2.5'
                placeholder='muhammadtayyabmt0@gmail.com' /></div>
                <div>
                ...
                <div className='mb-6'>
                    <label htmlFor='message ' className='text-white block text-sm mb-2 mt-4 font-medium'>Message
                    </label>
