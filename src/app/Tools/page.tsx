...
const Tools = (props: Props) => {
  return (
    <div className='w-10/12 mx-auto relative top-80'>
        <h1 className='md:text-4xl text-3xl lg:text-5xl font-bold mt-5'>Tools</h1>
        <p className='pt-6 text-neutral-300'>The products, apps and services I use on a daily basis for work and life
        </p>    
        <div className='mt-20 grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 sm:gap-10'>
            <a href="" className='border-[8.5px] border-neutral-500 block rounded-2xl my-6'>
                <div className='py-8 bg-neutral-800 w-full text-center rounded-t-2xl'>
                    <img className='max-w-[80px] rounded-2xl mx-auto brightness-90 contrast-125' src="planet.png" alt="" />
                </div>
            ...
            <a href="" className='border-[8.5px] border-neutral-500 block rounded-2xl my-6'>
                <div className='py-8 bg-neutral-800 w-full text-center rounded-t-2xl'>
                    <img className='max-w-[80px] rounded-2xl mx-auto brightness-90 contrast-125' src="figma.png" alt="" />
                </div>
                <div className='p-8 py-10'>
                    <h1 className='mb-1 font-bold'>Figma</h1>
                    <p className='text-neutral-400'>
                        My design tool for choice
                    </p>
                </div>
            </a>
            <a href="" className='border-[8.5px] border-neutral-500 block rounded-2xl my-6'>
